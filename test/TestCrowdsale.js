var HashnodeCrowdsale = artifacts.require("UmbalaCrowdsale");
var HashnodeToken = artifacts.require("UmbalaToken");
...
contract('HashnodeCrowdsale', function(accounts) {
    ...
    // it('call function setMyName', function(done){
    //     HashnodeCrowdsale.deployed().then(async function(instance) {
    //       await instance.setMyName("TranThoX");
    //       const stage = await instance.getMyName.call();
    //       console.log("New name " +stage);
    //       done();
    //    });
    // });

    it('call function send Token', function(done){
        HashnodeCrowdsale.deployed().then(async function(instance) {
            const token = await instance.token.call();
            console.log("token " + token);       
          await instance.reward('0x8dcf9850E9AE2d90F42eB57c3c8dEFaA41DC739e',50000000000);
          //const stage = await instance.getMyName.call();
          //console.log("New name " +stage);
          done();
       });
    ...
    // it('2 ETH should buy 5 Hashnode Tokens in PreICO', function(done){
    //     HashnodeCrowdsale.deployed().then(async function(instance) {
